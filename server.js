...
function normalizeMaterialCode(
  code
) {
  return String(code || '')
    .trim()
...
server.listen(
  ...
  () => {
    console.log(
      `Expert feedback system: http://localhost:${port}`
    );
  }
);
